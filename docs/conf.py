...
"""
eventful-django documentation build configuration file.
...
project = 'eventful-django'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Eventful Django App'
...
#
# html_title = 'eventful-django v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Eventful Django',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'eventful_django'),
                os.path.join(root_path, 'eventful_django/migrations')])
